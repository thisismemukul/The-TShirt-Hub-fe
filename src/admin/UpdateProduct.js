...
const UpdateProduct = () => {
  ...
  const preloadCategories = () => {
    ...
    const successMessage = () => {
        return (
            <>
                <Alert sx={{ display: createdProduct ? "" : "none" }} severity="success">{createdProduct} Updated Successfully</Alert>
            </>
        )
    };
    const errorMessage = () => {
                                        ...
                                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 5 }}>
                                            ...
                                            <Grid container justifyContent="flex-end">
                                                <Grid item>
                                                    ...
                                                    <Typography component="h3" variant="subtitle2">
                                                        Get Back to <NavLink className='link' to='/admin/products'>Show All Products</NavLink>
                                                    </Typography>
                                                </Grid>
                                            </Grid>
                                        </Box>
